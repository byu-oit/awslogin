...
def test_authenticate(mock_requests):
    ...
    auth_page_text = open(
        "{}/adfs_html_mocks/login_screen.html".format(script_dir), "r"
    ).read()
    ...
    duo_page_text = open(
        "{}/adfs_html_mocks/duo_screen.html".format(script_dir), "r"
    ).read()
    duo_screen_mock = MagicMock(status_code=200, text=duo_page_text)

    # Mock duo init page
    duo_init_text = open(
        "{}/adfs_html_mocks/duo_init.html".format(script_dir), "r"
    ).read()
    ...
    duo_auth_trans_init_json = open(
        "{}/adfs_html_mocks/duo-trans-init.json".format(script_dir), "r"
    ).read()
    ...
    duo_verify_code_json = open(
        "{}/adfs_html_mocks/duo_trans_verify.json".format(script_dir), "r"
    ).read()
    ...
    duo_auth_verify_json = open(
        "{}/adfs_html_mocks/duo_verify_result.json".format(script_dir), "r"
    ).read()
    ...
    duo_auth_result_json = open(
        "{}/adfs_html_mocks/duo_auth_result.json".format(script_dir), "r"
    ).read()
    ...
    mock_session.post.side_effect = [
        duo_screen_mock,
        duo_init_mock,
        duo_auth_trans_init_mock,
        duo_verify_code_mock,
        duo_auth_verify_mock,
        duo_auth_result_mock,
    ]
